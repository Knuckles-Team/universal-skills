...
- **Run first (in parallel):** Step 1 — Fan Out Per Component Analyze Code
- **After level 0:** Step 2 — C4 Diagram
- **After level 1:** Step 3 — Mermaid
- **After level 2:** Step 4 — Docs

...
- **Run first (in parallel):** Step 1 — Ingest Contract
- **After level 0:** Step 2 — Extract Clauses
- **After level 1:** Step 3 — Risk Analysis
- **After level 2:** Step 4 — Recommend
- **After level 3:** Step 5 — Summary

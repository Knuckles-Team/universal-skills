...
- **Run first (in parallel):** Step 1 — Scan Pantry
- **After level 0:** Step 2 — Compare To Meal Plan
- **After level 1:** Step 3 — Generate Shopping List
- **After level 2:** Step 4 — Organize

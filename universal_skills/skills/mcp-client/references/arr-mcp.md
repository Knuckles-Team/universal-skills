...
This server provides the following tool tags gated by environment variables:

| Tag | Env Variable | Default | Server |
| :--- | :--- | :--- | :--- |
| `bazarr-catalog` | `BAZARR_CATALOGTOOL` | `True` | `arr-mcp` |
| `bazarr-history` | `BAZARR_HISTORYTOOL` | `True` | `arr-mcp` |
| `bazarr-system` | `BAZARR_SYSTEMTOOL` | `True` | `arr-mcp` |
| `chaptarr-catalog` | `CHAPTARR_CATALOGTOOL` | `True` | `arr-mcp` |
| `chaptarr-config` | `CHAPTARR_CONFIGTOOL` | `True` | `arr-mcp` |
| `chaptarr-downloads` | `CHAPTARR_DOWNLOADSTOOL` | `True` | `arr-mcp` |
| `chaptarr-history` | `CHAPTARR_HISTORYTOOL` | `True` | `arr-mcp` |
| `chaptarr-indexer` | `CHAPTARR_INDEXERTOOL` | `True` | `arr-mcp` |
| `chaptarr-operations` | `CHAPTARR_OPERATIONSTOOL` | `True` | `arr-mcp` |
| `chaptarr-profiles` | `CHAPTARR_PROFILESTOOL` | `True` | `arr-mcp` |
| `chaptarr-queue` | `CHAPTARR_QUEUETOOL` | `True` | `arr-mcp` |
| `chaptarr-search` | `CHAPTARR_SEARCHTOOL` | `True` | `arr-mcp` |
| `chaptarr-system` | `CHAPTARR_SYSTEMTOOL` | `True` | `arr-mcp` |
| `lidarr-catalog` | `LIDARR_CATALOGTOOL` | `True` | `arr-mcp` |
| `lidarr-config` | `LIDARR_CONFIGTOOL` | `True` | `arr-mcp` |
| `lidarr-downloads` | `LIDARR_DOWNLOADSTOOL` | `True` | `arr-mcp` |
| `lidarr-history` | `LIDARR_HISTORYTOOL` | `True` | `arr-mcp` |
| `lidarr-indexer` | `LIDARR_INDEXERTOOL` | `True` | `arr-mcp` |
| `lidarr-operations` | `LIDARR_OPERATIONSTOOL` | `True` | `arr-mcp` |
| `lidarr-profiles` | `LIDARR_PROFILESTOOL` | `True` | `arr-mcp` |
| `lidarr-queue` | `LIDARR_QUEUETOOL` | `True` | `arr-mcp` |
| `lidarr-search` | `LIDARR_SEARCHTOOL` | `True` | `arr-mcp` |
| `lidarr-system` | `LIDARR_SYSTEMTOOL` | `True` | `arr-mcp` |
| `prowlarr-config` | `PROWLARR_CONFIGTOOL` | `True` | `arr-mcp` |
| `prowlarr-downloads` | `PROWLARR_DOWNLOADSTOOL` | `True` | `arr-mcp` |
| `prowlarr-history` | `PROWLARR_HISTORYTOOL` | `True` | `arr-mcp` |
| `prowlarr-indexer` | `PROWLARR_INDEXERTOOL` | `True` | `arr-mcp` |
| `prowlarr-operations` | `PROWLARR_OPERATIONSTOOL` | `True` | `arr-mcp` |
| `prowlarr-profiles` | `PROWLARR_PROFILESTOOL` | `True` | `arr-mcp` |
| `prowlarr-search` | `PROWLARR_SEARCHTOOL` | `True` | `arr-mcp` |
| `prowlarr-system` | `PROWLARR_SYSTEMTOOL` | `True` | `arr-mcp` |
| `radarr-catalog` | `RADARR_CATALOGTOOL` | `True` | `arr-mcp` |
| `radarr-config` | `RADARR_CONFIGTOOL` | `True` | `arr-mcp` |
| `radarr-downloads` | `RADARR_DOWNLOADSTOOL` | `True` | `arr-mcp` |
| `radarr-history` | `RADARR_HISTORYTOOL` | `True` | `arr-mcp` |
| `radarr-indexer` | `RADARR_INDEXERTOOL` | `True` | `arr-mcp` |
| `radarr-operations` | `RADARR_OPERATIONSTOOL` | `True` | `arr-mcp` |
| `radarr-profiles` | `RADARR_PROFILESTOOL` | `True` | `arr-mcp` |
| `radarr-queue` | `RADARR_QUEUETOOL` | `True` | `arr-mcp` |
| `radarr-system` | `RADARR_SYSTEMTOOL` | `True` | `arr-mcp` |
| `seerr-catalog` | `SEERR_CATALOGTOOL` | `True` | `arr-mcp` |
| `seerr-search` | `SEERR_SEARCHTOOL` | `True` | `arr-mcp` |
| `seerr-system` | `SEERR_SYSTEMTOOL` | `True` | `arr-mcp` |
| `sonarr-catalog` | `SONARR_CATALOGTOOL` | `True` | `arr-mcp` |
| `sonarr-config` | `SONARR_CONFIGTOOL` | `True` | `arr-mcp` |
| `sonarr-downloads` | `SONARR_DOWNLOADSTOOL` | `True` | `arr-mcp` |
| `sonarr-history` | `SONARR_HISTORYTOOL` | `True` | `arr-mcp` |
| `sonarr-indexer` | `SONARR_INDEXERTOOL` | `True` | `arr-mcp` |
| `sonarr-operations` | `SONARR_OPERATIONSTOOL` | `True` | `arr-mcp` |
| `sonarr-profiles` | `SONARR_PROFILESTOOL` | `True` | `arr-mcp` |
| `sonarr-queue` | `SONARR_QUEUETOOL` | `True` | `arr-mcp` |
| `sonarr-system` | `SONARR_SYSTEMTOOL` | `True` | `arr-mcp` |
...
### prowlarr-indexerdefaultcategories

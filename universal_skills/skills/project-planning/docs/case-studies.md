...
The hypothesis: What if we just give Agent access to the raw files and let it figure things out?
...
const agent = new ToolLoopAgent({
  model: "ai_provider/agent-opus-4.5",
  tools: {
...
- Agent Sonnet cached: $0.30/MTok
- Agent Sonnet uncached: $3.00/MTok
- 10x cost difference
...
## Case Study 4: AI Provider Multi-Agent Research

**Source**: AI Provider blog "How we built our multi-agent research system"
...
5. **Let agents improve themselves**: Agent 4 models can diagnose prompt failures and suggest improvements. Tool-testing agents can rewrite tool descriptions to avoid common mistakes.

# Single-Agent Template Reference

Use this template as a reference for building single-agent systems conforming to standard `agent-utilities` conventions.
...
```markdown
# IDENTITY.md - Single Agent Identity

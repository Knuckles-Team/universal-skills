...
class HeartbeatSessionModeTests(unittest.TestCase):
    ...
    def test_extract_context_left_percent_handles_missing_values(self):
        self.assertIsNone(
            main._extract_context_left_percent(
                "no context marker here", launcher="codex"
            )
        )
        self.assertIsNone(
            main._extract_context_left_percent("999% context left", launcher="codex")
        )
    ...
    def test_extract_context_left_percent_respects_provider_patterns(self):
        ...
        self.assertEqual(
            main._extract_context_left_percent(output, launcher="unknown-cli"), 18
        )

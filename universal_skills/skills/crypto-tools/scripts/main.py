...
def main():
    ...
    # hash-text
    hash_parser = subparsers.add_parser("hash-text", help="Hash text (md5, sha1, sha256, etc)")
    hash_parser.add_argument("--text", required=True, help="Text to hash")
    hash_parser.add_argument("--algorithm", default="sha256", help="Algorithm (sha256, md5, etc)")
    ...
    rsa_parser = subparsers.add_parser("rsa-key-pair-generator", help="Generate RSA Key Pair")
    rsa_parser.add_argument("--size", type=int, default=2048, help="Key size (e.g. 2048, 4096)")

...
- **Run first (in parallel):** Step 1 — Collect Timesheets
- **After level 0:** Step 2 — Calculate
- **After level 1:** Step 3 — Deductions
- **After level 2:** Step 4 — Approve
- **After level 3:** Step 5 — Distribute

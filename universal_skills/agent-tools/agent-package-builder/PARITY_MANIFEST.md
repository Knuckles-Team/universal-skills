...
| `docs/agent-readiness.schema.json` | R | Versioned machine-readable contract copied from the builder authority. |
...
| `markdown-mirror-manifest.json`, `agent-readiness-manifest.json` | R | Raw Markdown mapping and sorted provenance/applicability digests generated by the readiness tool. |
